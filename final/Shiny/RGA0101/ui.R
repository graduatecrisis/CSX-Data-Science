...
tagcut = read.csv("maintag_cut.csv", stringsAsFactors = F)
dummy.1 = dummy[-451, ]
  ...
  navbarPage("CSX_PCGame",  
            ...
            ,
             ...
             tabPanel("chart",
                      ...
                      sidebarPanel(
                        selectInput("inSelect", "Select input",c("Error")),
                        selectInput("inSelect2", "Select input",c("Error")),
                        selectInput("inSelect3", "Select input",c("Error")),
