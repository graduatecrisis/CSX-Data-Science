...
game.hcd = branches_attr_by_labels(game.hcd, winners, color = "red")
...
crireview.hcd = branches_attr_by_labels(crireview.hcd, winners, color = "red")
par(mar=c(0.8,1,0.8,18))
plot(critic.hcd,axes= FALSE, horiz = TRUE)  
```
...
plreview.hcd = branches_attr_by_labels(plreview.hcd, winners, color = "red")
par(mar=c(0.8,1,0.8,18))
plot(critic.hcd,axes= FALSE, horiz = TRUE)  
```
